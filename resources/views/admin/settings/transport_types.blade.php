    ...
    <div class="block-header">
        <div class="body table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                @foreach($transport_types as $m)
                    <tr>
                        <th scope="row">{{$m->id}}</th>
                        <td>{{$m->name}}</td>
                        <td>
                            <a href="{{route('EditTransportType',$m->id)}}"  class="btn btn-warning waves-effect">
                                <i class="material-icons">mode_edit</i>
                            </a>

                            <a href="{{route('DeleteTransportType',$m->id)}}"  class="btn btn-danger waves-effect">
    ...
    <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog" style="display: none;">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('CreateTransportType')}}" method="post">
