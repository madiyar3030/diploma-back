    ...
    <div class="block-header">
        ...
        <div class="body table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                @foreach(\App\Models\Option::all() as $m)
                    <tr>
                        <th scope="row">{{$m->id}}</th>
                        <td>{{$m->name}}</td>
                        <td>
                            <a href="{{route('EditOption',$m->id)}}"  class="btn btn-warning waves-effect">
                                <i class="material-icons">mode_edit</i>
                            </a>
                            <a href="{{route('DeleteOption',$m->id)}}"  class="btn btn-danger waves-effect">
